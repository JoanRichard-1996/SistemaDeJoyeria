...
public class Ticket {
    ...
    static ArrayList<String> CabezaLineas2 = new ArrayList<String>();
    static ArrayList<String> subCabezaLineas2 = new ArrayList<String>();
    static ArrayList<String> items2 = new ArrayList<String>();
    static ArrayList<String> totales2 = new ArrayList<String>();
    static ArrayList<String> LineasPie2 = new ArrayList<String>();
